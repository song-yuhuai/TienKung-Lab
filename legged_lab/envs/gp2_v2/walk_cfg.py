...
from legged_lab.assets.gp2_v2 import GP2_V2_CFG
...
class Gp2WalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/gp2_v2/datasets/motion_visualization/gp2_v3_walk3804.txt"]
    device: str = "cuda:0"
...
@configclass
class Gp2WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "gp2_walk"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "gp2_walk"
    wandb_project = "gp2_walk"
    resume = False
    load_run = ".*"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/gp2_v2/datasets/motion_amp_expert/gp2_v3_walk3804_expert.txt"]
