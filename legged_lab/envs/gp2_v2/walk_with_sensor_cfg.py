...
@configclass
class Gp2WalkWithSensorFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/gp2_v2/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
...
@configclass
class Gp2WalkWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/gp2_v2/datasets/motion_amp_expert/walk.txt"]
