...
from legged_lab.assets.x2 import validate_x2_usd_path
from legged_lab.envs.x2.walk_cfg import X2WalkFlatEnvCfg
...
class X2Env(VecEnv):
    def __init__(
        self,
        cfg: X2WalkFlatEnvCfg,
        headless,
    ):
        self.cfg: X2WalkFlatEnvCfg
        self.cfg = cfg
    ...
    def compute_current_observations(self):
        ...
        if not hasattr(self, "_printed_obs_order"):
            ...
            print("\n=== X2 compute_current_observations() DOF ORDER DEBUG ===")
