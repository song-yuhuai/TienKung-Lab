...
from legged_lab.assets.x2 import X2_CFG
...
@configclass
class X2WalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/x2/datasets/motion_visualization/x2_walk8328.txt"]
    device: str = "cuda:0"
...
@configclass
class X2WalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "x2_walk"
    run_name = ""
    logger = "tensorboard"
    neptune_project = "x2_walk"
    wandb_project = "x2_walk"
    resume = False
    load_run = ".*"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/x2/datasets/motion_amp_expert/x2_walk8328_expert.txt"]
