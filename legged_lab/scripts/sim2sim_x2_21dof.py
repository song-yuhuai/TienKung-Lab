...
class MujocoRunner:
    ...
    def init_variables(self) -> None:
        ...
        self.default_dof_pos = np.array(
            [-0.3, 0.0, 0.0, 0.61, -0.31, 0.0, #left leg
             -0.3, 0.0, 0.0, 0.61, -0.31, 0.0, #right leg
             0.0, #waist
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default=os.path.join(LEGGED_LAB_ROOT_DIR, "legged_lab/assets/X2_URDF-v1.3.0/x2_hand.xml"),
